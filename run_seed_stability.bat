...
if not exist "outputs\evaluation\%RUN777%\test_summary.json" (
  ...
  echo [4/5] Seed 777 evaluation already exists - skipping.
)

echo [5/5] Summarize seeds 42, 123, 777
