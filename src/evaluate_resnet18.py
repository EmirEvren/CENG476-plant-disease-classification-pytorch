...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description=(
            "Kaydedilmiş ResNet18 modelini kilitli "
...
def main():
    ...
    if checkpoint.get("model_name") not in (
        ...
        raise ValueError(
            ...
            "resnet18_transfer checkpoint'i kabul eder."
        )
    ...
    print("=" * 65)
    print("RESNET18 KİLİTLİ TEST DEĞERLENDİRMESİ")
    print("=" * 65)
